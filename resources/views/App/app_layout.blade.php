      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-5 col-md-12 col-12">
            ...
            <div class="top-left">
              <ul class="list-main">
                <li><i class="ti-headphone-alt"></i> +92308-1312527</li>
                <!-- <li><i class="ti-email"></i> support@onlinelayyah.com</li> -->
              </ul>
            </div>
            <!--/ End Top Left -->
          </div>
        ...
        <div class="row">
          <div class="col-lg-3 col-md-2 col-12">
            ...
            <div class="logo">
              ...
              <a href="{{url('index')}}"><h4>Online Layyah</h4></a>
            </div>
            <!--/ End Logo -->
            <!-- Search Form -->
        ...
        <div class="row">
          <div class="col-lg-5 col-md-6 col-12">
            ...
            <div class="single-footer about">
              <div class="logo">
                ...
                <h1 style="color: white">Online Layyah</h1>
              </div>
              <p class="text">Praesent dapibus, neque id cursus ucibus, tortor neque egestas augue,  magna eros eu erat. Aliquam erat volutpat. Nam dui mi, tincidunt quis, accumsan porttitor, facilisis luctus, metus.</p>
              <p class="call">Got Question? Call us 24/7<span><a href="tel:03081312527">+92 308 1312527</a></span></p>
            </div>
            <!-- End Single Widget -->
          </div>
          ...
          <div class="col-lg-3 col-md-6 col-12">
            ...
            <div class="single-footer social">
              ...
              <div class="contact">
                <ul>
                  <li>Thana City Wali Gali</li>
                  <li>Layyah Pakistan.</li>
                  <li>info@onlinelayyah.com</li>
                  <li>+92 308 1312527</li>
                </ul>
              </div>
              <!-- End Single Widget -->
              <ul>
        ...
        <div class="inner">
          <div class="row">
            <div class="col-lg-6 col-12">
              <div class="left">
                <p>Copyright © 2020 <a href="#" target="_blank">onlinelayyah.com</a>  -  All Rights Reserved.</p>
              </div>
            </div>
            <div class="col-lg-6 col-12">
              <div class="right">
