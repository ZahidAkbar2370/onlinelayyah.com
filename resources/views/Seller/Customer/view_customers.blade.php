					...
					<tbody>
						...
						@foreach($all_customers as $key => $customer)
							<tr>
								...
								<td>
									<a href="seller-view-loans/{{$customer->id}}" class="btn btn-info"><i class="align-middle" data-feather="eye"></i> <span class="align-middle"></span></a>
									<!-- <a href="seller-add-customer-loan/{{$customer->id}}" class="btn btn-info"><i class="align-middle" data-feather="plus"></i> <span class="align-middle"></span></a> -->
