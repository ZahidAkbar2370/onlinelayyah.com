					...
					<tbody>
						...
						@foreach($all_suppliers as $key => $supplier)
							<tr>
								...
								<td>
									<a href="seller-edit-supplier/{{$supplier->id}}" class="btn btn-info"><i class="align-middle" data-feather="edit"></i> <span class="align-middle"></span></a>
									<a href="seller-delete-supplier/{{$supplier->id}}" class="btn btn-danger"><i class="align-middle" data-feather="trash-2"></i> <span class="align-middle"></span></a>
								</td>
							</tr>
						@endforeach
						@endif
