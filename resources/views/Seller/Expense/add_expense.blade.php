                 ...
                 <div class="col-sm-10 col-md-8 col-lg-6 mx-auto d-table h-100">
                    <div class="d-table-cell align-middle">
                        ...
                        <div class="text-center">
                            <h1><b>Add Expense</b></h1>
                        </div>

                        <div class="card">
                            <div class="card-body">
                                <div class="m-sm-4">
                                     <form method="POST" action="{{URL::to('seller-save-add-expense')}}">
                                        @csrf()

                                        <div class="mb-3">
                                            <label class="form-label">Title</label>
                                            <input id="title" class="form-control form-control-lg @error('title') is-invalid @enderror" value="{{ old('title') }}" type="text" name="title" placeholder="Enter your Title" required  autocomplete="title" autofocus/>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input id="amount" class="form-control form-control-lg @error('amount') is-invalid @enderror" value="{{ old('amount') }}" type="text" name="amount" placeholder="Enter your Amount" required  autocomplete="amount" autofocus/>
