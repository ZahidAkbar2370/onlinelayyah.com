                                ...
                                <div class="m-sm-4">
                                     <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input id="email" class="form-control form-control-lg @error('email') is-invalid @enderror"  type="email" name="email" placeholder="Enter your email" value="seller@gmail.com" required  autocomplete="email" autofocus/>
